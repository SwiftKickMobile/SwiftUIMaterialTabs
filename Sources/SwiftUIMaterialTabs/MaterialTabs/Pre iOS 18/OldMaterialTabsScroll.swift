...
public struct OldMaterialTabsScroll<Content, Tab, Item>: View where Content: View, Tab: Hashable, Item: Hashable {
    ...
    @StateObject private var scrollModel: OldScrollModel<Item, Tab>
